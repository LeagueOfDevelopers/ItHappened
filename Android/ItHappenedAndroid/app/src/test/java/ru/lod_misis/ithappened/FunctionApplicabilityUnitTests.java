...
public class FunctionApplicabilityUnitTests {
    ...
    public void WeHaveValidTracking_AvrgRatingFAShouldntReturnNull(){
        ...
        Event eventFirst = new Event(UUID.randomUUID(), tracking.GetTrackingID(), null, new Rating(4),  "122");
        Event eventSecond = new Event(UUID.randomUUID(), tracking.GetTrackingID(), null, new Rating(5),  "122");
    ...
    public void WeHaveValidTracking_AvrgScaleFAShouldntReturnNull(){
        ...
        Event eventFirst = new Event(UUID.randomUUID(), tracking.GetTrackingID(), 10.0, new Rating(4),  "122");
        Event eventSecond = new Event(UUID.randomUUID(), tracking.GetTrackingID(), -15.4, new Rating(5),  "122");
