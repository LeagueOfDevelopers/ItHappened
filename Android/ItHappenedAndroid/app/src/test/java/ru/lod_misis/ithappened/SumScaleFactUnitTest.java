...
public class SumScaleFactUnitTest {
    ...
    public void TrackingDontHaveScaleCustomization_ApplicabilityFunctionShouldReturnFalse(){
        ...
        Assert.assertFalse(new SumScaleFact(testTracking).applicabilityFunction());
    }
    ...
    public void TrackingHaveScaleCustomization_ApplicabilityFunctionShouldReturnTrue(){
        ...
        Assert.assertTrue(new SumScaleFact(testTracking).applicabilityFunction());
    }
    ...
    public void TrackingHaveRequariedScaleCustomization_GetSumValueShouldBeCorrectWorking(){
        ...
        Double sumValue = new SumScaleFact(testTracking).getSumValue().doubleValue();

        Assert.assertTrue(sumValue.doubleValue() == 26.1);
    }
    ...
    public void TrackingHaveRequariedScaleCustomization_GetSumValueShouldBeReturnNull(){
        ...
        Double sumValue = new SumScaleFact(testTracking).getSumValue();

        Assert.assertTrue(sumValue == null);
    }
