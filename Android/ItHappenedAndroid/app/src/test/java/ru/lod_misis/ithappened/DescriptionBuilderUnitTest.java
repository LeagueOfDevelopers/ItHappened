...
public class DescriptionBuilderUnitTest {
    ...
    public void CorrDescriptionTest_DescriptionBuilderBuildCorrectCorrelationDescription() {
        ...
        Assert.assertTrue(fact1.textDescription().equals("C <b>маленькой</b> вероятностью при увеличении количества <b>килограммы</b> в событии <b>я поел мороженного</b> происходит увеличение количества <b>килограммы</b> в событии <b>я потолстел</b>."));
        Assert.assertTrue(fact2.textDescription().equals("C <b>очень большой</b> вероятностью при увеличении числа событий <b>я поел мороженного</b> происходит увеличение числа событий <b>я потолстел</b>."));
